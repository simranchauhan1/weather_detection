...
function showWeatherReport(weather){
     ...
     minmaxTemp.innerHTML = `${Math.floor(weather.main.temp_min)-273}&deg;c (min)/ ${Math.ceil (weather.main.temp_max)-273}&deg;C (max) `;
     ...
     if(weatherType.textContent == 'Clear'){
        ...
        document.body.style.backgroundImage = "url('images/Lightening.jpg')";
    }
